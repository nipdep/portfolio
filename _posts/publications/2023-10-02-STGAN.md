        ...
        <div class="inner no-padding" >
            ...
            <table>
                <tr>
                    ...
                    <td class="second-column"><a href="#" class="button small disable">Neural Artistic Style Transfer with Conditional Adversarial Networks</a></td>
                </tr>
                <tr>
                    <td class="first-column"><a href="#" class="button special small">Date</a></td>
                    <td class="second-column"><a href="#" class="button small disable">Dec 2021</a></td>
                </tr>
                <tr>
                    <td class="first-column"><a href="#" class="button special small">Venue</a></td>
                    <td class="second-column"><a href="#" class="button small disable">Arxiv</a></td>
                </tr>
                <tr>
                    <td class="first-column"><a href="#" class="button special small disable">Status</a></td>
                    <td class="second-column"><a href="#" class="button small disable">Published</a></td>
                </tr>
                <tr>
                    <td class="first-column"><a href="#" class="button special small">Authors</a></td>
                    <td class="second-column"><a href="#" class="button small disable">Pathirage N. Deelaka</a></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="second-column"><a href="https://arxiv.org/abs/2302.03875#:~:text=A%20neural%20artistic%20style%20transformation,style%20of%20a%20famous%20image." class="button special small"><i class="fa-solid fa-file-pdf"></i>Paper</a></td>
                </tr> 
            </table>
            </div>
        </div>
